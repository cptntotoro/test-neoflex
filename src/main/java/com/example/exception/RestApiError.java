...
public class RestApiError {
    ...
    private RestApiError(String status, String reason, String message, LocalDateTime timestamp) {
        this.status = status;
        this.reason = reason;
    ...
    public static class Builder {
        ...
        public RestApiError build() {
            return new RestApiError(status, reason, message, timestamp);
        }
    }
}
